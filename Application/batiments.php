...
<body>
	<?php
		makeheader("batiments");
	?>
	
	<div class="container" style="margin-top: 3vh">
		<div class="row justify-content-center">
			<?php maketable("batiments", "batiments.php"); ?>
		</div>
		...
		<div class="row justify-content-center" style="position: fixed; top: 9.5vh; left: 50px; width: 200px">
			<form action="" method="POST">
				...
				<input type="hidden"  name="NumBat"  class="form-control"  value="<?php echo $NumBat ?>"  disabled>
				
				<div class="form-group">
					<label>Nom</label>
					<input type="text"  name="NomBat"  class="form-control"  placeholder="Nom"  value="<?php echo $NomBat ?>">
				</div>
				
				<div class="form-group">
					<?php
					if ($update) { echo "<button type='submit'  name='ModifBatiment'  class='btn btn-info'>Modifier</button>"; }
					else         { echo "<button type='submit'  name='CreerBatiment'  class='btn btn-primary'>Créer</button>"; }
					?>
				</div>
			</form>
		</div>
